...
<body>
   ...
   <section class="add-products">
      ...
      <h1 class="heading">Ajouter le produit</h1>
      ...
      <form action="" method="post" enctype="multipart/form-data">
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <input type="number" min="0" class="box" required max="999999" placeholder="Entrez le prix du produit" onkeypress="if(this.value.length == 10) return false;" name="price">
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
               <span>Image 02 (Conseiller)</span>
               <input type="file" name="image_02" accept="image/jpg, image/jpeg, image/png, image/webp" class="box">
            </div>
            <div class="inputBox">
               <span>Image 03 (Conseiller)</span>
         ...
         ?>
               <div class="box">
                  ...
                  <div class="flex-btn">
                     ...
                     <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">supprimer</a>
                  </div>
               </div>
         <?php
            }
