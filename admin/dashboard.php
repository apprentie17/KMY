...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <h3>Codes Promo</h3>
         <?php
            $select_promo = $conn->prepare("SELECT * FROM `promo`");
            $select_promo->execute();
            $number_of_promo = $select_promo->rowCount()
         ?>
         <p><?= $number_of_promo; ?></p>
         <a href="code_promo.php" class="btn">Voir Code Promo</a>
      </div>
      ...
      <div class="box">
         <?php
            ...
            $select_completes->execute(['terminée']);
      ...
      <div class="box">
         ...
         <p>Utilisateurs</p>
         <a href="users_accounts.php" class="btn">Voir utilisateurs</a>
      </div>
