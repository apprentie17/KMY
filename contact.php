...
if (isset($_POST['send'])) {
   ...
   if ($select_message->rowCount() > 0) {
      ...
      $message[] = 'Envoyé le message avec succès !';
   }
}
...
<body>
   ...
   <section class="contact">
      ...
      <form action="" method="POST">
         ...
         <input type="text" name="number" min="0" max="9999999999" placeholder="Entrez votre numéro" required onkeypress="if(this.value.length == 10) return false;" class="box">
